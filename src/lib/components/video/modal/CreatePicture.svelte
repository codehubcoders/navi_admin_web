        ...
        <div class="modal">
            ...
            <div class="modal__body">
                ...
                <div class="thumbnail">
                    ...
                    <p class="gray-small">jpg, png 파일로 업로드</p>
                </div>
            ...
            <div class="modal__button">
                <button class="btn-gray mr-10" on:click={handleCreatePicture}
                    >취소</button
                >
                <button class="btn-primary" on:click={handleCreatePicture}
                    >등록하기</button
                >
            </div>
        </div>
