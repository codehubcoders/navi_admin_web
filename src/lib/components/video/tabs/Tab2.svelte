<script>
	import CreateCulture from './../modal/CreateCulture.svelte';
...
<section class="seach-sort-table">
    <CreateCulture {showCreateCulture} on:click={handleCreateCulture} />
    <div class="seach-sort-table__header">
        <p class="title">문화 관리</p>
        <div class="right">
            ...
            {#if !process}
                    ...
                    <button class="btn-primary-border-none" on:click={handleCreateCulture}
                        >등록</button
                    >
