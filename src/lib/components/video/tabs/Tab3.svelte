<script>
	import CreatePicture from './../modal/CreatePicture.svelte';
    ...
    export let showCreatePicture = false;
    const handleCreatePicture = () => {
        showCreatePicture = !showCreatePicture;
    };
</script>

<section class="seach-sort-table">
    <CreatePicture {showCreatePicture} on:click ={handleCreatePicture} />
    <div class="seach-sort-table__header">
        <p class="title">사진 관리</p>
        <div class="right">
            ...
            {#if !process}
                    ...
                    <button class="btn-primary-border-none" on:click ={handleCreatePicture}
                        >등록</button
                    >
